...
public class RotateTowardsTargetState : States
{
    ...
    public override States Tick(EnemyManager enemyManager, EnemyStats enemyStats, EnemyAnimatorController enemyAnimatorController)
    {
        ...
        {
            enemyAnimatorController.PlayerTargetAnimationWithRootRotation("Turn Behind", true);
        ...
        && !enemyManager.IsInteracting)
        {
            enemyAnimatorController.PlayerTargetAnimationWithRootRotation("Turn Right", true);
            return _combatStanceState;
        }
        ...
        && !enemyManager.IsInteracting)
        {
            enemyAnimatorController.PlayerTargetAnimationWithRootRotation("Turn Left", true);
            return _combatStanceState;
        }
